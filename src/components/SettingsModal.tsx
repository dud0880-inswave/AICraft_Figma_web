  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between pt-4">
        <button
          onClick={handleClear}
          className="px-4 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-red-900/20 rounded"
        >
          토큰 삭제
        </button>
        <button
...
export default function SettingsModal({ isOpen, onClose, token, onSaveToken }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* 모달 */}
      <div className="relative bg-gray-800 rounded-lg shadow-xl w-full max-w-lg mx-4">
        {/* 헤더 */}
