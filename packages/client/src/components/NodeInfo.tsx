  ...
  if (!node) {
    return (
      <div className="h-full theme-bg-secondary p-4">
        <p className="theme-text-secondary text-sm">노드를 선택하면 상세 정보가 표시됩니다</p>
      </div>
    )
  }
  ...
  return (
    <div className="h-full theme-bg-secondary flex flex-col">
      <div className="px-4 py-2 border-b theme-border">
        <h2 className="text-sm font-medium theme-text-secondary">노드 정보</h2>
      </div>
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="space-y-3">
          {properties.map(({ label, value }) => (
            <div key={label}>
              <dt className="text-xs theme-text-secondary">{label}</dt>
              <dd className="text-sm theme-text-primary mt-0.5 break-all">
                {renderValue(value)}
              </dd>
            </div>
          ))}
        ...
        {node.fills && node.fills.length > 0 && (
          <div className="mt-4 pt-4 border-t theme-border">
            <h3 className="text-xs theme-text-secondary mb-2">Fills</h3>
            <pre className="text-xs theme-text-primary theme-bg-tertiary p-2 rounded overflow-auto max-h-32">
        ...
        {node.style && (
          <div className="mt-4 pt-4 border-t theme-border">
            <h3 className="text-xs theme-text-secondary mb-2">텍스트 스타일</h3>
            <pre className="text-xs theme-text-primary theme-bg-tertiary p-2 rounded overflow-auto max-h-32">
