var WebSquareLang = {
    ...
    E_includeFrame_duplicated_Msg: "[IncludeFrame %1] : id[%2] is duplicated. Please change the ID.",
    E_includeFrame_duplicatedFunc_Msg: "[IncludeFrame %1] : function[%2] is duplicated. Please change the function name.",
    //logMsg.html
    ...
    Calendar_deselect_all: "Cancel All",
    ...
    MultiUpload_err_fileNameNotAllow: "This filename is not allowed. (%1)",
    // Pagelist
    ...
    TabControl_tab_close: "%1 tab close",
    ...
    Grid_filter_condition_equal: "Equal",
    Grid_filter_condition_no_equal: "No Equal",
    Grid_filter_condition_greater_than: "Greater than",
    Grid_filter_condition_less_than: "Less than",
    Grid_filter_condition_greater_than_or_equal: "Greater than or equal",
    Grid_filter_condition_less_than_or_equal: "Less than or equal",
    ...
    Grid_filter_condition7: "Wildcard character(*,?)",
    ...
    //mfeSubmission
    MFE_required_property: "%1 error : Required property(id, channelId) is not defined. %2",
    MFE_client_not_found: "executeMfe : Target mfeClient not found.",
    MFE_required_id_channelId: "%1 : id and channelId are required.",
    MFE_duplicate_id: "%1 : ID already exists (%2).",
    MFE_header_sync_error: "Header Sync Error: %1",
    MFE_no_matching_server: "No MFEServer matching channelId '%1'.",
    MFE_context_url_missing: "contextUrl is not specified.",
    MFE_popup_unavailable: "popup component is not available.",
    MFE_context_options_parse_error: "contextOptions parse error: %1",
    MFE_popup_create_failed: "Popup creation failed: %1",
    MFE_popup_wframe_not_found: "Cannot find wframe inside popup: %1",
    MFE_self_wframe_not_found: "context='self': Cannot find wframe in current scope.",
    MFE_self_setSrc_failed_detail: "_navigateSelf: setSrc failed (scope_id=%1, activeStatus=%2, url=%3)",
    MFE_self_setSrc_failed: "context='self': setSrc failed. (scope_id=%1)",
    MFE_filter_error: "MFE Filter Error on %1: %2",
    EXPR_compile_error: "expr compile error — expression: '%1', cause: %2",
    EXPR_scope_not_found: "expr binding failed — scope '%1' not found (component: %2)",
    EXPR_setter_failed: "expr property dispatch failed — property: '%1', setter: %2",
    EXPR_grid_rebuild: "expr Tier 3 property changed — rebuilt gridView '%1' via setGridStyle",
    PFC_tool_executing: "%1 executing...",
    PFC_tool_completed: "Completed",
    PFC_progress_summary: "%1 / %2 completed"
};