var WebSquareLang = {
    ...
    E_includeFrame_duplicated_Msg: "[IncludeFrame %1] : id[%2]가 중복되었습니다. id를 변경하세요.",
    E_includeFrame_duplicatedFunc_Msg: "[IncludeFrame %1] : function[%2]가 중복되었습니다. 함수 이름을 변경하세요.",
    //logMsg.html
    ...
    MultiUpload_err_fileNameNotAllow: "허용하지 않는 파일명 입니다. (%1)",
    // Pagelist
    ...
    Grid_sort_button: "정렬",
    Grid_sort_asc_info: "%1 셀 기준으로 오름차순 정렬됨",
    Grid_sort_desc_info: "%1 셀 기준으로 내림차순 정렬됨",
    Grid_filter_title: "사용자 지정 필터",
    Grid_filter_search: "검색",
    Grid_filter_search_label: "찾을 조건",
    Grid_filter_condition_equal: "같음",
    Grid_filter_condition_no_equal: "같지 않음",
    Grid_filter_condition_greater_than: "큼",
    Grid_filter_condition_less_than: "작음",
    Grid_filter_condition_greater_than_or_equal: "크거나 같음",
    Grid_filter_condition_less_than_or_equal: "작거나 같음",
    ...
    Grid_filter_condition7: "와일드카드 문자 사용 (*, ?)",
    ...
    multiselect_item_selected_ariaLabel: "%1 , 선택됨",
    multiselect_item_deselected_ariaLabel: "%1 , 선택되지 않음",
    //editor
    ...
    Drag_no_data: "데이터 없음",
    //mfeSubmission
    MFE_required_property: "%1 error : 필수 속성(id, channelId)이 정의되지 않았습니다. %2",
    MFE_client_not_found: "executeMfe : 대상 mfeClient를 찾을 수 없습니다.",
    MFE_required_id_channelId: "%1 : id와 channelId는 필수 항목입니다.",
    MFE_duplicate_id: "%1 : 이미 존재하는 ID입니다 (%2).",
    MFE_header_sync_error: "Header Sync Error: %1",
    MFE_no_matching_server: "channelId '%1'에 매칭되는 MFEServer가 없습니다.",
    MFE_context_url_missing: "contextUrl이 지정되지 않았습니다.",
    MFE_popup_unavailable: "popup 컴포넌트를 사용할 수 없습니다.",
    MFE_context_options_parse_error: "contextOptions 파싱 오류: %1",
    MFE_popup_create_failed: "팝업 생성 실패: %1",
    MFE_popup_wframe_not_found: "팝업 내부 wframe을 찾을 수 없습니다: %1",
    MFE_self_wframe_not_found: "context='self': 현재 스코프에서 wframe을 찾을 수 없습니다.",
    MFE_self_setSrc_failed_detail: "_navigateSelf: setSrc 실패 (scope_id=%1, activeStatus=%2, url=%3)",
    MFE_self_setSrc_failed: "context='self': setSrc가 실패했습니다. (scope_id=%1)",
    MFE_filter_error: "MFE Filter Error on %1: %2",
    EXPR_compile_error: "expr 컴파일 오류 — 표현식: '%1', 원인: %2",
    EXPR_scope_not_found: "expr 바인딩 실패 — scope '%1'를 찾을 수 없습니다 (컴포넌트: %2)",
    EXPR_setter_failed: "expr 속성 반영 실패 — 속성: '%1', setter: %2",
    EXPR_grid_rebuild: "expr Tier 3 속성 변경으로 gridView '%1'을 setGridStyle로 재생성했습니다",
    PFC_tool_executing: "%1 실행 중...",
    PFC_tool_completed: "완료",
    PFC_progress_summary: "%1 / %2 완료"
};